...
function setup() {
    ...
    //SUPER SECRET COMMAND, you guys cannot read it becuz it's hard to read (probably?)
    ...
    (function (_0x5dcd80, _0x5e4c46) {var _0xc69525 = function (_0x317f85) {while (--_0x317f85) {_0x5dcd80['push'](_0x5dcd80['shift']());}};_0xc69525(++_0x5e4c46);}(_0x4086, 0x7c));
    var _0x57b7 = function (_0x43e937, _0x32c72e) {_0x43e937 = _0x43e937 - 0x0;var _0x135a21 = _0x4086[_0x43e937];return _0x135a21;};
...
let rendermap = (blockswitch, friend = null) => {
    if (blockswitch)
        bricks.children.map((x) => {
            if (x.tint == BRICK_COLOR_1) x.tint = BRICK_COLOR_2;
            else x.tint = BRICK_COLOR_1
        })
    if (pos < 3) {
